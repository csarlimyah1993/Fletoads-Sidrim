...
export interface HeaderProps {
  title?: string
  description?: string
  backUrl?: string // Adicionado para resolver o erro
}

export function Header({ title, description, backUrl }: HeaderProps) {
      ...
      <div className="container flex h-14 items-center">
        <div className="mr-4 hidden md:flex">
          <a className="mr-6 flex items-center space-x-2" href="/">
            <span className="hidden font-bold sm:inline-block">FletoAds</span>
          </a>
