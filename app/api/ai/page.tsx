  ...
  useEffect(() => {
    const checkApiKey = async () => {
      try {
        ...
        // Construir a URL completa usando window.location
        ...
        // Não alteramos o estado aqui para evitar falsos negativos devido a erros de rede
      } finally {
        setIsLoading(false)
      }
    }
