...
import { Edit, QrCode, Printer, Globe, ExternalLink } from "lucide-react"
...
export default function PerfilLojaClient({ initialLoja }: { initialLoja: any }) {
  const [loja] = useState(initialLoja)
